                                ...
                                <tr class="bg-white">
                                    ...
                                    <td class="px-6 py-4 flex items-center">
                                        ...
                                        <a href="{{ route('consultas.create', $cita->id) }}"
                                            class="font-medium hover:bg-gray-200 text-blue-600 py-1 px-2 border border-blue-500 rounded-lg mr-1">Iniciar
                                            consulta</a>
                                        @else
                                        <a href="{{ route('consultas.show', $cita->id_consulta) }}"
                                            class="font-medium hover:bg-gray-200 text-blue-600 py-1 px-2 border border-blue-500 rounded-lg mr-1">Ver consulta</a>
                                        @endif
                                        <a href="#"
                                            class="font-medium hover:bg-gray-200 text-blue-600 py-1 px-2 border border-blue-500 rounded-lg mr-1"><i
                                        ...
                                        <form action="#" method="post">
                                            ...
                                            <button type="submit"
                                                ...
                                                class="font-medium hover:bg-gray-200 text-blue-600 hover:underline py-1 px-2 border border-blue-500 rounded-lg mr-1"><i
