<x-app-layout>
    ...
    <div class="mt-6 bg-white p-6 mx-6 mb-6 rounded-2xl drop-shadow-md">
        ...
        <div class="flex justify-center">
            <form action="{{ route('productos.update', $producto->id) }}" method="POST" class="w-full sm:w-1/2">
                @csrf
                @method('PUT')
                ...
                <div class="form-group flex flex-col mt-3">
                    <label for="marca" class="block mb-2 text-sm font-medium text-gray-900">Marca del
                        producto:</label>
                    <input type="text" id="marca" name="marca" class="form-control"
                    value="{{ $producto->marca }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                    <label for="costo" class="block mb-2 text-sm font-medium text-gray-900">Precio del
                        producto:</label>
                    <input type="text" id="costo" name="costo" class="form-control"
                    value="{{ $producto->costo }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                    <label for="cantidad" class="block mb-2 text-sm font-medium text-gray-900">Cantidad
                        disponible:</label>
