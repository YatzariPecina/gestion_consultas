<x-app-layout>
    <div class="mt-6 bg-white p-6 mx-6 mb-6 rounded-2xl drop-shadow-md text-center">
        <h1 class="text-2xl font-extrabold">Editar paciente</h1>
    </div>
    ...
    <div class="mt-6 bg-white p-6 mx-6 mb-6 rounded-2xl drop-shadow-md">
        ...
        <div class="flex justify-center">
            <form action="{{ route('pacientes.update', $paciente->id) }}" method="POST" class="w-full sm:w-1/2">
                @csrf
                @method('PUT')
                <div class="form-group flex flex-col">
                    <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900">Nombre:</label>
                    <input type="text" id="nombre" name="nombre" class="form-control"
                        placeholder="Ingrese el nombre" value="{{ $paciente->nombre }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                    ...
                    <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control"
                        placeholder="Ingrese la fecha de nacimiento" value="{{ $paciente->fecha_nacimiento }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                ...
                <div class="form-group flex flex-col mt-3">
                    ...
                    <input type="tel" id="telefono_paciente" name="telefono_paciente" class="form-control"
                        placeholder="Ingrese el telefono del paciente" value="{{ $paciente->telefono_paciente }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                    <label for="direccion" class="block mb-2 text-sm font-medium text-gray-900">Direccion:</label>
                    <input type="text" id="direccion" name="direccion" class="form-control"
                        placeholder="Ingrese la direccion del paciente" value="{{ $paciente->direccion }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                    ...
                    <input type="text" id="nacionalidad" name="nacionalidad" class="form-control"
                        placeholder="Ingrese la nacionalidad del paciente" value="{{ $paciente->nacionalidad }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                    <label for="correo" class="block mb-2 text-sm font-medium text-gray-900">Correo
                        electronico:</label>
                    <input type="email" id="correo" name="correo" class="form-control"
                        placeholder="Ingrese el correo electronico" value="{{ $paciente->correo }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                    ...
                    <input type="text" id="nombre_contacto_emergencia" name="nombre_contacto_emergencia"
                        class="form-control" value="{{ $paciente->nombre_contacto_emergencia }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                    ...
                    <input type="tel" id="telefono_contacto_emergencia" name="telefono_contacto_emergencia"
                        class="form-control" value="{{ $paciente->telefono_contacto_emergencia }}">
                </div>
                <div class="form-group flex flex-col mt-3">
                ...
                <div class="form-group flex flex-col mt-3">
                    ...
                    <textarea id="observaciones" name="observaciones" rows="4"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="Escribe tus observaciones">{{ $paciente->observaciones }}</textarea>
                </div>
