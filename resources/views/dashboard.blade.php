        ...
        <div class="sm:flex block justify-center">
            <div
                ...
                <a href="{{ route('servicios.index') }}"
                    class="bg-gradient-to-t from-[#60ECEC] to-[#A6FFAF] hover:bg-gradient-to-t hover:from-[#59d3d3] hover:to-[#9cf1a5] inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Ir
            ...
            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow w-full sm:w-1/3 my-2 sm:mx-2 flex flex-col items-start justify-between">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Estudios</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700">Listado de los estudios creados.</p>
            ...
            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow w-full sm:w-1/3 my-2 sm:mx-2 flex flex-col items-start justify-between">
                ...
                <p class="mb-3 font-normal text-gray-700">Listado de los productos creados.</p>
